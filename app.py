...
st.markdown("<h1 style='text-align: center; color: #5f7f7a;'>Convierte tu Texto a Audio</h1>", unsafe_allow_html=True)
...
text = st.text_area("Pon aqui el texto que quieres escuchar.")
